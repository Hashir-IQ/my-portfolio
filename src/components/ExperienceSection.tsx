    ...
    <section id="experience" className="py-12 border-b border-gray-200">
      ...
      <div className="space-y-0">
        {experiences.map((exp: any, i: number) => {
          ...
          if (company.includes("technolean")) {
            logoUrl = "/assets/technolean_logo.png";
          } else if (company.includes("innova")) {
            logoUrl = "/assets/innova_workmen_logo.jpeg";
          } else if (company.includes("brain ex")) {
            logoUrl = "/assets/brain_ex_world_logo.jpeg";
          }
